...
if(NOT SHCORE_EDITOR_LIBRARY OR NOT SHSDK_EDITOR_LIBRARY OR NOT SHCOMPILER_EDITOR_LIBRARY)
	message(FATAL_ERROR "Could not find one of the editor libraries (ShCore: ${SHCORE_EDITOR_LIBRARY}, ShSDK: ${SHSDK_EDITOR_LIBRARY}, ShCompiler: ${SHCOMPILER_EDITOR_LIBRARY}")
endif(NOT SHCORE_EDITOR_LIBRARY OR NOT SHSDK_EDITOR_LIBRARY OR NOT SHCOMPILER_EDITOR_LIBRARY)

set(SHSDK_EDITOR_LIBRARIES "${SHCORE_EDITOR_LIBRARY}" "${SHSDK_EDITOR_LIBRARY}" "${SHCOMPILER_EDITOR_LIBRARY}" CACHE PATH "ShSDK Editor libraries") # ugly
set(SHINE_EDITOR_EXT_DIR "${SHINE_ROOT_DIR}/Bin/Extensions" CACHE PATH "Extension directory") # ugly too
message("SHINE_EDITOR_EXT_DIR = ${SHINE_EDITOR_EXT_DIR}")
